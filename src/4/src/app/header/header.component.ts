...
export class HeaderComponent implements OnInit {
  ...
  constructor( private router: Router, private authService: AuthService
   ...
   get isAdmin() {
    ...
    // console.log('HeaderComponent isAdmin getAuthorities = ' + this.authService.getAuthorities());
    // console.log('HeaderComponent isAdmin getAuthorities = ' + this.authService.getAuthorities()[0]);

    // console.log('HeaderComponent isAdmin currentAuthStatus = ' + this.currentAuthStatus);
